...
<script type="text/javascript" src="<c:url value="/js/member/joinCheck.js"/>"></script>
<script type="text/javascript" src="<c:url value="/js/member/joinAjaxData.js"/>"></script>
...
<table width="100%" height="10">
	<tr>
		<td align="right">
			...
			<img alt="창닫기" src="./img/close_btn.gif" style="border: 0">
			</a>
		</td>
	</tr>
</table>
