...
<link href="<c:url value="/css/joinCss.css"/>"  rel="stylesheet" type="text/css">
<link href="<c:url value="/css/loading.css"/>"  rel="stylesheet" type="text/css">
<script type="text/javascript" src="<c:url value="/js/member/joinMask.js"/>"></script>
<script type="text/javascript" src="<c:url value="/js/member/loading.js"/>"></script>
...
<div id="loadingImage"><img src="<c:url value="/img/loading.gif"/>"></div>
